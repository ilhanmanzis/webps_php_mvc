...
<div class="card shadow mb-4">
    <div class="card-header py-3 d-flex justify-content-between">
        <h6 class="mt-1 font-weight-bold text-primary">Lihat Pengeluaran</h6>
        <form action="<?=BASEURL?>/allpengeluaran/getallpengeluaran" method="post">
            <button type="submit" name="cetak" class="btn btn-sm btn-success">Lihat Semua Pengeluaran</button>
        </form>
    </div>
    <div class="card-body">
        <form action="<?=BASEURL;?>/allpengeluaran/caripengeluaran" method="post">
