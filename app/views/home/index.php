...
$pengeluaranToday=0;
    ...
    endforeach;
    foreach($data['pengeluaranToday'] as $pengeluaran):
        $pengeluaranToday += $pengeluaran['jumlah_pengeluaran'] ;
    endforeach;
$jumlahToday = $totalToday - $pengeluaranToday;
?>
        ...
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    ...
                    <div class="h5 mb-0 font-weight-bold text-gray-800">Rp. <?=$pengeluaranToday?></div>
                </div>
                <div class="col-auto">
        ...
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    ...
                    <div class="h5 mb-0 font-weight-bold text-gray-800">Rp. <?=$jumlahToday?></div>
                </div>
                <div class="col-auto">
                    <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                </div>
...
$pengeluarans = 0;
    ...
    foreach($data['pengeluaran'] as $pengeluaran):
        $pengeluarans += $pengeluaran['jumlah_pengeluaran'] ;
    endforeach;
    $jumlah = $total - $pengeluarans;
?>
        ...
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                        Total Pengeluaran</div>
                    <div class="h5 mb-0 font-weight-bold text-gray-800">Rp. <?=$pengeluarans;?></div>
                </div>
                <div class="col-auto">
                    <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                </div>
